...
Devise.setup do |config|
  ...
  # config.secret_key = 'f95fbdd5e0f46db7428af14a65d20eeb9ca0d0b5948269467d74def767e40815563d99b52d582e04f76aa8b2356d0264bc689d394fe6b2876b1f09b520289453'
  ...
  # config.pepper = '495bdcbd161f1784a6f4a7d65db5e8cd537ffeb9215f666aca729f0c2eda2248711385b1bad8dadbba3f8fbeb6d69e5705f1e18d666ca502aec1868dbd178200'
  ...
  # Only AdminUser enables :timeoutable (see the AdminUser model) — the
  # admin panel's blast radius (orders, customer PII, pricing) justifies an
  # idle timeout that the customer-facing User model doesn't need.
